...
from warpsense.contracts.coaching import CoachingAssignment, Drill
from warpsense.contracts.shared_enums import CoachingStatus
from warpsense.contracts.schemas.benchmark import WelderBenchmarks
from warpsense.contracts.schemas.coaching import (
