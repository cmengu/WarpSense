...
Usage:
    from warpsense.agents.warpsense_langchain_agent import WarpSenseLangChainAgent
...
_KB_PATH = Path(__file__).resolve().parent / "knowledge" / "chroma_db"
...
from warpsense.agents.warpsense_agent import LLM_MODEL, WeldQualityReport, ThresholdViolation
from warpsense.agents.specialists import (
    compute_violations,
    thermal_triggered,
    geometry_triggered,
    process_triggered,
)
from warpsense.features.session_feature_extractor import SessionFeatures, OPTIMAL_ANGLE_DEG
from warpsense.classifier.weld_classifier import WeldPrediction
