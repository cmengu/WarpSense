...
from warpsense.observability.logging_config import configure_logging
configure_logging()
...
from evals.eval_scenarios import SCENARIOS, EvalScenario, get_scenarios_by_category
...
class MultiAgentEvaluator:
    def __init__(self, llm_runs: int = 1, verbose: bool = True):
        ...
        kb_path = Path(__file__).resolve().parent.parent / "warpsense" / "agents" / "knowledge" / "chroma_db"
