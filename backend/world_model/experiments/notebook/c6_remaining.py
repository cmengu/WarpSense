...
n_blocks=4, ratio 0.40-0.50, EMA 0.996, seed 1337), 1 seed for the sweep:
  ...
  knob 1 (masking ratio/style): oneblock, scattered15, lowratio, highratio
...
LOGS = NOTEBOOK / "logs"
MANIFEST = NOTEBOOK / "c6_manifest_remaining.csv"
...
CONFIGS: list[tuple[str, list[str]]] = [
    ("scattered15",   ["--mask-style", "scattered", "--ratio", "0.15", "0.15"]),
    ("lowratio",      ["--ratio", "0.15", "0.25"]),
    ("highratio",     ["--ratio", "0.55", "0.65"]),
