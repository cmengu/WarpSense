...
def extract_pressure_features(sensor_readings: List[Dict[str, Any]]) -> Dict[str, float]:
    """
...
def extract_temperature_features(sensor_readings: List[Dict[str, Any]]) -> Dict[str, float]:
    """
...
def extract_torch_angle_features(sensor_readings: List[Dict[str, Any]]) -> Dict[str, float]:
    """
