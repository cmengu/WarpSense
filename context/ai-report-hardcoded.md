...
> **For AI:** Reference with `@context/seagull-pilot-context.md` to avoid reimplementing or violating patterns.  
...
| `context/overall-stack-context.md` | Backend + frontend data flow |
